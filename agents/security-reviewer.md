...
Load the `_pr-review-rubric` skill and follow its severity scale, output contract, and the **Security review** section's tool routing exactly. The skill is the source of truth — do not invent your own rubric.
